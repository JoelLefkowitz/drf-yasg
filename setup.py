...
python_requires = ", ".join(
    [">=2.7"] + ["!=3.{}.*".format(v) for v in range(0, py3_supported_range[0])]
)
python_classifiers = [
    ...
    "Programming Language :: Python :: 3.{}".format(v)
    for v in range(*py3_supported_range)
]
...
def drf_yasg_setup(**kwargs):
    setup(
        ...
        extras_require={"validation": requirements_validation,},
        license="BSD License",
        description="Automated generation of real Swagger/OpenAPI 2.0 schemas from Django Rest Framework code.",
        long_description=description,
        url="https://github.com/joellefkowitz/drf-yasg2",
        author="Cristi V.",
...
try:
    ...
    if (
        ...
        or os.getenv("TRApip install toxVIS", "false") == "true"
    ):
